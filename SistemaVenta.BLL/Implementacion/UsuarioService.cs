    ...
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            try
            {
                ...
                entidad.Clave = _utilidadesService.ConvertirSha256(clave_generada); //le pasamos la clave generada.
                ...
                if(UrlPlantillaCorreo != "")
                {
                    ...
                    if(response.StatusCode == HttpStatusCode.OK)
                    {
                        using (Stream dataStream = response.GetResponseStream())
                        {
                            ...
                            if(response.CharacterSet == null) // Otra validación por caracteres especiales
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("No hay ningun usuario vinculado al correo.");
                ...
                if (!correo_enviado)
                    throw new TaskCanceledException("No se puede restablecer. Problemas al enviar el correo.");
