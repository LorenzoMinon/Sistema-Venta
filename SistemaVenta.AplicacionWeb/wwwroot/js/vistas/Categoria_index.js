...
$("#btnGuardar").click(function () {
    ...
    if ($("#txtDescripcion").val().trim() == ""){
        toast.warning("", "Debe completar el campo : descripcion")
        $("#txtDescripcion").focus() //el cursor se mueve directamente al campo con txtdesc
        return;
    }
    ...
    if (modelo.idCategoria == 0) { // 0 para crear.
        ...
        fetch("/Categoria/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "Categoria modificada", "success")
                } else {
